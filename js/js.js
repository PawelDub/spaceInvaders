...
function drawCanvas() {
    ...
    $(".body").append(
        `<canvas width="1470" height="870" id="can">
...
function gameOver() {
    ...
    $("p#user-result").get(0).innerHTML = user.name
    $("p#user-best-time").get(0).innerHTML = user.resultTime;
    $("p#user-best-result").get(0).innerHTML = user.result;
